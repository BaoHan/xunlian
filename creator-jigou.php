<?php/*创建帐号，商户管理页面
	...
	@ since 1.4
	@ 将本页的 creator.php 命名为creator-jigou.php
    ...
    <div class="row-fluid">
      ...
      <div class="span12">
          ...
          <div class="widget-title">
            ...
            <h5>机构账户列表</h5><div class="buttons" style="float:left !important;"><a  href="#jigou" data-toggle="modal" class="btn btn-mini">+ 创建机构账户</a></div> 
